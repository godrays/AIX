...
void registerAllBenchmarks()
{
    ...
    REGISTER_BENCHMARK(BenchmarkTensorFuseChainContigF3210M)
    REGISTER_BENCHMARK(BenchmarkTensorFuseDualChainContigF3210M)
    REGISTER_BENCHMARK(BenchmarkTensorFuseChainStridedF324M)
    REGISTER_BENCHMARK(BenchmarkTensorFuseAdamF3210M4P)
